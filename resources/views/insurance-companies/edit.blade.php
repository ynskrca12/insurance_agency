...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-10 mx-auto">
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                    <div>
                        <h1 class="h3 mb-1 fw-bold text-dark">
                            <i class="bi bi-pencil me-2"></i>Şirket Düzenle
                        </h1>
                        <p class="text-muted mb-0 small">{{ $insuranceCompany->name }}</p>
                    </div>
                    <div class="d-flex gap-2">
                        <a href="{{ route('insurance-companies.show', $insuranceCompany) }}" class="btn btn-info action-btn">
            ...
            <form method="POST" action="{{ route('insurance-companies.update', $insuranceCompany) }}" enctype="multipart/form-data" id="companyForm">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="form-card card">
                            ...
                            <div class="card-body">
                                ...
                                @else
                                <div id="currentLogo" class="logo-container">
                                    <div class="text-muted">
                                        <i class="bi bi-image" style="font-size: 3rem;"></i>
                                        <p class="mb-0 mt-2">Logo yüklenmemiş</p>
                                    </div>
                                </div>
                                @endif

                                <div id="logoPreview" class="logo-container has-image" style="display: none;">
                                    <div>
                                        <img id="logoPreviewImage" class="logo-image">
                                        <div class="logo-label">Yeni Logo Önizleme</div>
                                    </div>
                                </div>
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <button type="button" class="btn btn-danger btn-delete" onclick="deleteCompany()">
                                <i class="bi bi-trash me-2"></i>Şirketi Sil
                            </button>
                            <a href="{{ route('insurance-companies.show', $insuranceCompany) }}" class="btn btn-light action-btn">
...
function deleteCompany() {
    if (confirm('⚠️ DİKKAT!\n\nBu sigorta şirketini silmek istediğinizden emin misiniz?\n\n• Tüm ilgili kayıtlar etkilenebilir\n• Bu işlem geri alınamaz!\n\nDevam etmek istiyor musunuz?')) {
        // Loading overlay
        $('body').append(`
